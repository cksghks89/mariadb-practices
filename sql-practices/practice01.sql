...
select count(distinct emp_no) from salaries where salary >= 120000 and to_date like '9999%';
...
select count(distinct emp_no) from titles where title = 'Engineer' and to_date like '9999%';
